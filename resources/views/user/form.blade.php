        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="id_gerai" class="col-lg-3 col-lg-offset-1 control-label">Gerai</label>
                        <div class="col-lg-6">
                            <select name="id_gerai" id="id_gerai" class="form-control" required>
                                <option value="">Pilih Gerai</option>
                                @foreach ($gerai as $key => $item)
